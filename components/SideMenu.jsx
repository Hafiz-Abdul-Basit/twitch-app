...
const SideMenu = () => {
  return (
    <>
      <div className=" fixed w-14 sm:w-16 xl:w-[16rem] h-screen p-2 bg-[#0e0e10]">
        <div>
          <p className=" hidden xl:flex uppercase font-bold text-sm mb-5">
        ...
        <div>
          <p className=" hidden xl:flex uppercase font-bold text-sm mt-5 mb-5">
            Top Channels
          </p>
          <p>
            <RiMovieLine
              size={25}
              className=" mt-8 xl:hidden justify-center w-full"
            />
          </p>
        </div>
