...
const LiveChannels = () => {
  return (
    <>
      <div id="live" className=" p-2 md:p-6">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-4 py-2">
          <LiveChannelItem
            img={Live1}
            profile_img="https://static.vecteezy.com/system/resources/thumbnails/007/404/139/small/cute-panda-gaming-cartoon-icon-illustration-animal-technology-icon-concept-isolated-premium-flat-cartoon-style-vector.jpg"
          ...
          <LiveChannelItem
            img={Live2}
            profile_img="https://img.icons8.com/color/600/000000/games-folder.png"
          ...
          <LiveChannelItem
            img={Live3}
            profile_img="https://cdna.artstation.com/p/assets/images/images/029/471/072/large/tricks-gfx-zombiesim2iconps.jpg?1597669718"
          ...
          <LiveChannelItem
            img={Live7}
            profile_img="https://img2.bc.game/game/image/5b3a4099-9462-4d3c-a854-ade78aad0d60.png?w=100&auto=format&cs=tinysrgb&blur=100"
